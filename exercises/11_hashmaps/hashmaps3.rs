...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        match scores.get_mut(team_1_name) {
            Some(team_1_tally) => {
                team_1_tally.goals_scored += team_1_score;
                team_1_tally.goals_conceded += team_2_score;
            }
            None => {
        ...
        match scores.get_mut(team_2_name) {
            Some(team_2_tally) => {
                team_2_tally.goals_scored += team_2_score;
                team_2_tally.goals_conceded += team_1_score;
            }
            None => {
